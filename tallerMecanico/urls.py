...
from .views import cerrarSesion, eliminarAtencion, filtrar, index, pagModificarAtencion, mostrarAtencion, servicios, ubicacion, consulta, registrarse, galeria , iniciarSesion, detalleAtencion, mostrarAtencion, administrarAtencion, actualizar, insertarImagen
